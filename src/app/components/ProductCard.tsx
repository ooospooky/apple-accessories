...
export const ProductCard: React.FC<IProductCard> = ({ id, category, name, width, height, src, price, productIndex }) => {
  ...
  return (
    <li key={id} className={`bg-[#f2f2f2] list-none overflow-hidden rounded-3xl border-4 border-solid border-white ${productIndex === 2 ? "basis-2/3" : "basis-1/3"} flex flex-col justify-end`}>
      <div >
