...
export const ProductInfoAndCompatibility: React.FC<IproductInfoAndCompatibilityProps> = ({ productInfo, compatibilityInfo }) => {
  ...
  return (
    <>
      <div>
        <button onClick={() => setProductInfoDropdownOpen(!productInfoDropdownOpen)} className="flex flex-row content-center justify-between w-full py-12 border-t border-[#d2d2d7]">
      ...
      {compatibilityInfo && (
        ...
        <div>
          <button onClick={() => setCompatibilityInfoDropdownOpen(!compatibilityInfoDropdownOpen)} className="flex flex-row content-center justify-between w-full py-12 border-t border-[#d2d2d7]">
