    ...
    <div className={`flex ${flexDirection} gap-10`}>
      <div className="flex flex-row gap-1">
        ...
        <div className="flex flex-col gap-1">
          ...
          <span className="text-xl font-normal"><span className="text-xl font-semibold">今天</span>，地點：Apple 台北 101</span>
        </div>
      </div>
      <div className="flex flex-row gap-1">
        <Image src="/svg/boxtruck.svg" priority width={25} height={25} alt="truck" className='mr-3' />
        <div className="flex flex-col gap-1">
